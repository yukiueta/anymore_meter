...
class BillingSummary(models.Model):
    ...
    project_id = models.IntegerField(null=True, blank=True, verbose_name='案件ID')
    ...
    fetch_status = models.CharField(max_length=20, choices=FETCH_STATUS_CHOICES, default='pending', verbose_name='取得ステータス')

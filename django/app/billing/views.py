...
class BillingSummaryByProjectView(APIView):
    ...
    def get(self, request):
        ...
        return Response({
            ...
            'prev_used_import': latest.prev_used_import,
            'curr_used_import': latest.curr_used_import,
            'prev_used_export': latest.prev_used_export,
            'curr_used_export': latest.curr_used_export,
    ...
    def get(self, request):
        ...
        for item in queryset:
            items.append({
                ...
                'deemed_method': item.deemed_method,
                'deemed_adjustment_kwh': str(item.deemed_adjustment_kwh),
